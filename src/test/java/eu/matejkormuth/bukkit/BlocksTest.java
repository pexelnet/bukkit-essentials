...
public class BlocksTest {
    ...
    public void testWater1() {
        ...
        assertTrue("water is not water",
                Blocks.isWater(Mockito.verify(waterBlock)));
    }
    ...
    public void testWater2() {
        ...
        assertTrue("static water is not water",
                Blocks.isWater(Mockito.verify(waterBlock)));
    }
    ...
    public void testLava1() {
        ...
        assertTrue("lava is not lava", Blocks.isLava(Mockito.verify(lavaBlock)));
    }
    ...
    public void testLava2() {
        ...
        assertTrue("static lava is not lava",
                Blocks.isLava(Mockito.verify(lavaBlock)));
    }
    ...
    public void testSign1() {
        ...
        assertTrue("wall sign is not sign",
                Blocks.isSign(Mockito.verify(block)));
    }
    ...
    public void testSign2() {
        ...
        assertTrue("post sign is not sign",
                Blocks.isSign(Mockito.verify(block)));
    }
    ...
    public void testSign3() {
        ...
        assertTrue("sign is not sign", Blocks.isSign(Mockito.verify(block)));
    }
    ...
    public void testGlassPane1() {
        ...
        assertTrue("this glass is not glass pane",
                Blocks.isGlassPane(Mockito.verify(block)));
    }
